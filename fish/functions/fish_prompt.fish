function fish_prompt --description 'Write out the prompt'
    ...
    echo -n -s (set_color yellow) "$USER" $normal @ (set_color magenta) (prompt_hostname) $normal ' ' (set_color $color_cwd) (prompt_pwd) $normal (fish_vcs_prompt) $normal $prompt_status " " (set_color red)'❯'(set_color yellow)'❯'(set_color green)'❯ '
end
